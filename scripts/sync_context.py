...
def build_summary() -> str:
    ...
    summary = [
        ...
        "- la linea mas nueva ya no es solo `R10 -> R8 -> ESI`; ahora incluye la rama `family14` y la trampa `xabort`",
        ...
        "---------------------",
        "- la ruta mas avanzada y repetible termina en `crackme+0x1e0ae4c = xabort 0xDC`",
        "- la pila estable observada es:",
        "  - `crackme+0x1e0ae4c`",
        "  - `crackme+0x1203bb4`",
        "  - `crackme+0x55da8b5`",
        "- parchear `0x55da8b5`, `0x55da8b0` o `0x55da8d9` no evita ese sink",
        "",
        "Implicacion",
        "-----------",
        "- el selector real esta por encima de `0x55da8b5`",
